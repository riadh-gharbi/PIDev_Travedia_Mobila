 ...
 * @author Ameni
 */
public class FrontDestination extends BaseForm {
    Container c = new Container(BoxLayout.x());
Container cxx = new Container(BoxLayout.xCenter());
public FrontDestination() {
        this(com.codename1.ui.util.Resources.getGlobalResources());
    }

    public FrontDestination(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        getToolbar().setTitleComponent(
              /*  FlowLayout.encloseCenterMiddle(
                        ...
                        new Label("                             amani", "Title")
                ));
                        setLayout(BoxLayout.y());
                       
                       
        //setLayout(BoxLayout.y());
       // for(int i=0;i<serviceDestination.getInstance().getAllDestination().size();i++)
               ArrayList<entities.Destination> List =serviceDestination.getInstance().getAllDestination();
       ...
       EncodedImage placeholder = EncodedImage.createFromImage(Image.createImage(1100, 500), false);
        ...
        Label titre = new Label(dest.getNom());
        ...
        public void actionPerformed(ActionEvent evt) {
          ...
          // ServiceCategoriet.getInstance().categorieid(id);
      //  new ModifCategt(id).show();
        }
    });
      int id1=dest.getId();
        ...
        btndel.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                new BaseForm().show();
                 //      serviceDestination.getInstance().deletecat(id1);
                      }
                });
        Container cxx = new Container(BoxLayout.xCenter());
        cxx.add(titre).add(btndel);
        //this.add(new ImageViewer(urlImage)).add(cxx);
