 ...
 * @author Ameni
 */
public class testafficherdestinations extends BaseForm{
     Form current;
    public testafficherdestinations (Resources res){        
   ...
   private void addTab(Tabs swipe, Image img, Label spacer, String likesStr, String commentsStr, String text) {
    ...
    private void addButton(Image img,Destination reg,Resources res){
       ...
       lSupprimer.addPointerPressedListener(l->{
           ...
           if (dig.show("Suppression", "Vous voulez supprimer cette destination ?","Annuler","Oui")){
               ...
               dig.dispose();
               if(serviceDestination.getInstance().Delete(reg.getId())){
                   new testafficherdestinations(res).show();
                   //refreshTheme();
               }     
           }
       });
       ...
       lModifier.addPointerPressedListener(l->{
           new ModifierDestinationForm(res,reg).show();});
