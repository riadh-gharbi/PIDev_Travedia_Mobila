 ...
 * @author user
 */
public class AjoutRegion extends BaseForm{
      Form current;
               String filePath = "";

    public AjoutRegion (Resources res){
...
//            }
        ...
        btnAjouter.addActionListener((e) ->{
            ...
            if(nom.getText() == ""){
                ...
                Region cat = new Region (String.valueOf(nom.getText()
                    ).toString(),
                    filePath);
                System.out.println("data categorie =="+cat);
                
                serviceRegion.getInstance().ajoutR(cat);
