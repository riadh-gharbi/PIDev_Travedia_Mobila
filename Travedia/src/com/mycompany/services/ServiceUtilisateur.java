...
import com.mycompany.entities.Profile;
...
public class ServiceUtilisateur {
    ...
    public boolean signup(TextField nom, TextField prenom, TextField email, TextField password, ComboBox role, ComboBox langue) {
        ...
        String url = Statics.BASE_URL + "/user/signUp?nom=" + nom.getText().toString() + "&prenom=" + prenom.getText().toString() + "&email=" + email.getText().toString() + "&password=" + password.getText().toString() + "&roles=" + role.getSelectedItem().toString() + "&langue=" + langue.getSelectedItem().toString();
