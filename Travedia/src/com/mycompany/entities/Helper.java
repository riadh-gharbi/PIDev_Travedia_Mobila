...
public class Helper {
    ...
    public static ComboBoxFarhadni createComboBox(String link, String titleField, String descField, String uniqueField) {
        ComboBoxFarhadni theBox = new ComboBoxFarhadni();
    ...
    public static class ComboBoxFarhadni {

        public class ComboBoxFarhadniElement {

            public String title;
            public String Description;
            public int uniqueId;

            ComboBoxFarhadniElement(String t, String d, int id) {
                title = t;
                Description = d;
                uniqueId = id;
            }
        ...
        public ComboBoxFarhadniElement getSelected() {
            if (Box.getSelectedItem() == null) {
                return null;
            }
            return new ComboBoxFarhadniElement(Box.getSelectedItem().get("Line1").toString(), Box.getSelectedItem().get("Line2").toString(), uniqueId.get(Box.getSelectedIndex()));
        }
