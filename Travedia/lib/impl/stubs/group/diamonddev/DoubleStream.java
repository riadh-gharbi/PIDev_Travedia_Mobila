 ...
 *  @since 1.0.0
 */
public final class DoubleStream implements function.Closeable {
	 ...
	 */
	public static DoubleStream of(iterator.PrimitiveIterator.OfDouble iterator) {
	}
	 ...
	 */
	public static DoubleStream generate(function.DoubleSupplier s) {
	}
	 ...
	 */
	public static DoubleStream iterate(double seed, function.DoubleUnaryOperator f) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public static DoubleStream iterate(double seed, function.DoublePredicate predicate, function.DoubleUnaryOperator op) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public static DoubleStream concat(DoubleStream a, DoubleStream b, DoubleStream[] rest) {
	}
	 ...
	 */
	public iterator.PrimitiveIterator.OfDouble iterator() {
	}
	 ...
	 *  @return the new stream
	 */
	public DoubleStream filter(function.DoublePredicate predicate) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream filterIndexed(function.IndexedDoublePredicate predicate) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream filterIndexed(int from, int step, function.IndexedDoublePredicate predicate) {
	}
	 ...
	 *  @return the new stream
	 */
	public DoubleStream filterNot(function.DoublePredicate predicate) {
	}
	 ...
	 */
	public DoubleStream map(function.DoubleUnaryOperator mapper) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream mapIndexed(function.IndexedDoubleUnaryOperator mapper) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream mapIndexed(int from, int step, function.IndexedDoubleUnaryOperator mapper) {
	}
	 ...
	 */
	public Stream mapToObj(function.DoubleFunction mapper) {
	}
	 ...
	 */
	public IntStream mapToInt(function.DoubleToIntFunction mapper) {
	}
	 ...
	 */
	public LongStream mapToLong(function.DoubleToLongFunction mapper) {
	}
	 ...
	 */
	public DoubleStream flatMap(function.DoubleFunction mapper) {
	}
	 ...
	 *  @return the new {@code DoubleStream}
	 */
	public DoubleStream sorted(java.util.Comparator comparator) {
	}
	 ...
	 *  @return the new stream
	 */
	public DoubleStream peek(function.DoubleConsumer action) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream scan(function.DoubleBinaryOperator accumulator) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream scan(double identity, function.DoubleBinaryOperator accumulator) {
	}
	 ...
	 *  @return the new {@code DoubleStream}
	 */
	public DoubleStream takeWhile(function.DoublePredicate predicate) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public DoubleStream takeUntil(function.DoublePredicate stopPredicate) {
	}
	 ...
	 *  @return the new {@code DoubleStream}
	 */
	public DoubleStream dropWhile(function.DoublePredicate predicate) {
	}
	 ...
	 *  @param action the action to be performed on each element
	 */
	public void forEach(function.DoubleConsumer action) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public void forEachIndexed(function.IndexedDoubleConsumer action) {
	}
	 ...
	 *  @since 1.0.0
	 */
	public void forEachIndexed(int from, int step, function.IndexedDoubleConsumer action) {
	}
	 ...
	 *  @see #max()
	 */
	public double reduce(double identity, function.DoubleBinaryOperator accumulator) {
	}
	 ...
	 */
	public OptionalDouble reduce(function.DoubleBinaryOperator accumulator) {
	}
	 ...
	 */
	public Object collect(function.Supplier supplier, function.ObjDoubleConsumer accumulator) {
	}
	 ...
	 */
	public boolean anyMatch(function.DoublePredicate predicate) {
	}
	 ...
	 */
	public boolean allMatch(function.DoublePredicate predicate) {
	}
	 ...
	 *  provided predicate, or the stream is empty, otherwise {@code false}
	 */
	public boolean noneMatch(function.DoublePredicate predicate) {
	}
	 ...
	 *  @since 1.0.1
	 */
	public static interface class DoubleMapMultiConsumer {
		 ...
		 */
		public void accept(double value, function.DoubleConsumer consumer) {
		}
	}
}
